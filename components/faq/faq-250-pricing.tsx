...
export default function Faq250Pricing() {
      ...
      >
        ...
        <Flex sx={{ gap: 3, flexDirection: ['column', 'row'] }}>
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_250_CLASS_A}
          ...
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_250_CLASS_B}
          ...
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_250_CLASS_C}
