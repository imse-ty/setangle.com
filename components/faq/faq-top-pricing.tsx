...
export default function FaqTopPricing() {
      ...
      >
        ...
        <Flex sx={{ gap: 3, flexDirection: ['column', 'row'] }}>
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_TOP_CLASS_A}
          ...
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_TOP_CLASS_B}
          ...
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_TOP_CLASS_C}
