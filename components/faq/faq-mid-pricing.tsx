...
export default function FaqMidPricing() {
      ...
      >
        ...
        <Flex sx={{ gap: 3, flexDirection: ['column', 'row'] }}>
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_MID_CLASS_A}
          ...
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_MID_CLASS_B}
          ...
          <OfferCard
            ...
            price={process.env.NEXT_PUBLIC_MID_CLASS_C}
