...
coverImage: /projects/splice/splice-cover.png
videoUrl: 'https://vimeo.com/904595962?share=copy'
summary: >
  Leading the initial creative direction for [Ravie.co](https://ravie.co/), we
...
We had to design with both vertical and horizontal formats in mind, as it was intended for use on Instagram and YouTube viewing. Everything was made in square 4K format to easily be cropped to any aspect ratio required.
...
We created a concept for a band of instruments representing the sables during R\&D and explored creative ideas around it.
...
Toward the end of the project, we repurposed existing assets created by the team and me to create 15-second versions of the video.
...
<ProjectCredits
  ...
  names={[
    ...
    { name: "Nick Patterson", title: "STORM+SHELTER" },
    { name: "Gruff Vaughan", title: "STORM+SHELTER" },
    {
      name: "Sebastian Anus",
      title: "Ronroco Audio",
