...
videoUrl: 'https://vimeo.com/918364472'
summary: >
  Collaborated with [Ravie.co](https://ravie.co/) on two videos for Space and
  Time, a decentralized data warehouse focusing on blockchain and AI.


  Here's a breakdown of how we helped
...
Initially, we aimed for a high-end appearance, but after exploration, we found out that the client preferred a more literal and minimalistic approach, where we would take existing designs of the app and enhance them with motion.
...
Our expertise in development proved to be helpful for this project. Once we finalized the visual style, we took care of the technical aspects and deconstructed the UX designs provided by the Space and Time team.
...
Meanwhile, Will was responsible for UI animation and developed a motion language using the visual style we had developed, which served as the foundation for the project, effectively turning our workflow into an assembly line.
...
Our role in this project was to create the best galaxy sequence ever, leading the creation of additional scenes such as the animation of a blockchain graph in 3D and the merging of two dwarf stars.
...
<ProjectCredits
  ...
  names={[
    ...
    { name: "Spencer Reeves", title: "Space and Time" },
    { name: "Catherine Daly", title: "Space and Time" }
  ]}
/>
